...
//	private ByteBuffer vBuffer;
	...
	public GLRenderer(MainActivity activity) {
		...
		mTexture = ByteBuffer.allocateDirect(mTextureData.length * 4)
				.order(ByteOrder.nativeOrder()).asFloatBuffer();
		mTexture.put(mTextureData).position(0);
...
//		vBuffer = createByteBuffer(vBytes); 
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		mTexture.position(0);
		GLES20.glVertexAttribPointer(mTexCoordLoc, 2, GLES20.GL_FLOAT, false, 0, mTexture);
